          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-6 mb-12">
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg sm:text-xl font-source text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-fade-in">
                  Live mining data, AI insights, and instant engagement - 
                  see performance metrics and get answers in real-time.
                </p>
              </div>
            </div>
          </div>
          
          {/* Live Data Dashboard - Prominent Position */}
